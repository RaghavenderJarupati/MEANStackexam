...
var url = 'mongodb://localhost:27017/tridenthotels';
...
if (err){console.log(err);}
 ...
 console.log(result);
 res.send(result.firstname+" "+result.lastname+" ("+result.phone+") will checkin on "+result.date+" and checkout on "+result.dateTo);
	}
        });
        }
    });
